...
public enum TraceRequestAttributes implements CharSequence {
     ...
     */
    CURRENT_SPAN("micronaut.opentelemetry.currentSpan"),

    /**
     * The attribute used to store the current scope.
     */
    CURRENT_SCOPE("micronaut.opentelemetry.currentScope"),

    /**
     * The attribute used to store the current span context.
     */
    CURRENT_SPAN_CONTEXT("micronaut.opentelemetry.currentSpanContext");
     ...
     */
    TraceRequestAttributes(String attr) {
        this.attr = attr;
    }
