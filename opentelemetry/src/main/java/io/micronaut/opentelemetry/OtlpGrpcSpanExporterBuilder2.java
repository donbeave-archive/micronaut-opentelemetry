...
public final class OtlpGrpcSpanExporterBuilder2 {
     ...
     */
    public OtlpGrpcSpanExporterBuilder2 setChannel(ManagedChannel channel) {
     ...
     */
    public OtlpGrpcSpanExporterBuilder2 setTimeout(long timeout, TimeUnit unit) {
     ...
     * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
     */
    public OtlpGrpcSpanExporterBuilder2 setTimeout(Duration timeout) {
     ...
     */
    public OtlpGrpcSpanExporterBuilder2 setEndpoint(String endpoint) {
     ...
     */
    public OtlpGrpcSpanExporterBuilder2 setTrustedCertificates(byte[] trustedCertificatesPem) {
     ...
     * OtlpGrpcSpanExporterBuilder2#endpoint} is set to build channel.
     *
     * @param key header key
     * @param value header value
     * @return this builder's instance
     */
    public OtlpGrpcSpanExporterBuilder2 addHeader(String key, String value) {
        if (metadata == null) {
     ...
     */
    public OtlpGrpcSpanExporter2 build() {
        if (channel == null) {
        ...
        return new OtlpGrpcSpanExporter2(channel, timeoutNanos);
    }

    OtlpGrpcSpanExporterBuilder2() {}
}
