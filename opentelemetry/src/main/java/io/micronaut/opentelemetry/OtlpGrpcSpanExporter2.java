 ...
 */
@ThreadSafe
public final class OtlpGrpcSpanExporter2 implements SpanExporter {

    private static final String EXPORTER_NAME = io.opentelemetry.exporter.otlp.trace.OtlpGrpcSpanExporter.class.getSimpleName();
    ...
    private final ThrottlingLogger logger =
            new ThrottlingLogger(Logger.getLogger(io.opentelemetry.exporter.otlp.trace.OtlpGrpcSpanExporter.class.getName()));
     ...
     */
    OtlpGrpcSpanExporter2(ManagedChannel channel, long timeoutNanos) {
    ...
    public CompletableResultCode export(Collection<SpanData> spans) {
        ...
        TraceServiceGrpc.TraceServiceBlockingStub exporter;
        if (timeoutNanos > 0) {
        ...
        try {
            ExportTraceServiceResponse response = exporter.export(exportTraceServiceRequest);
     ...
     */
    public static OtlpGrpcSpanExporterBuilder2 builder() {
        return new OtlpGrpcSpanExporterBuilder2();
    }

    /**
     * Returns a new {@link io.opentelemetry.exporter.otlp.trace.OtlpGrpcSpanExporter} reading the configuration values from the
     ...
     *
     * @return a new {@link io.opentelemetry.exporter.otlp.trace.OtlpGrpcSpanExporter} instance.
     */
    public static OtlpGrpcSpanExporter2 getDefault() {
